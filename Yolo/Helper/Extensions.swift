...
//  Yolo
//
//  Created by Nitin Khurana on 21/03/20.
...
extension UIButton {
    ...
    func setSelectedColor(color: String) {
        setTitleColor(UIColor(hexString: color), for: UIControl.State.highlighted)
        setTitleColor(UIColor(hexString: color), for: UIControl.State.selected)
